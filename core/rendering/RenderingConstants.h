...
{
	static const unsigned int maxVertexAtribs = (3 + 4 + 1 + 2 + 3); // Position, Color, MaterialIndex, TexCoords, Normal
	...
	static const unsigned int baseVertexCount = baseQuadCount * 1000;
	static const unsigned int baseIndexCount = baseQuadCount * 1000;
